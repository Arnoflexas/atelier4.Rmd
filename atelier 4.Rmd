...
```{r}
nutriage <- read.csv("~/Documents/CEU 1er anné/biostat/atelier/Atelier4-master/nutriage.csv"
names(nutriage)
```
...
par(new=T)
plot(z_h,z_h,type="l",col="red",xlim=c(-3,3))
```
...
qqplot(z_h,N,xlim=c(-3,3),ylim=c(-3,3))
par(new=T)
plot(z_f,z_f,type="l",col="red",xlim=c(-3,3))
```
